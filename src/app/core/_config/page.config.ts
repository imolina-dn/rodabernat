export class PageConfig {
	public defaults: any = {
		clientes: {
			page: {
				title: 'Clientes',
				desc: 'Listado y edición de clientes'
			},
		},
		presupuestos: {
			page: {
				title: 'Presupuestos',
				desc: 'Listado y edición de presupuestos'
			},
		},
		albaranes: {
			page: {
				title: 'Albaranes',
				desc: 'Listado y edición de albaranes'
			},
		},
		partes: {
			page: {
				title: 'Partes',
				desc: 'Listado y edición de partes'
			},
		},
		'partes-sin-val': {
			page: {
				title: 'Partes sin Val.',
				desc: 'Listado y edición de partes sin val.'
			}
		},
		ngbootstrap: {
			accordion: {
